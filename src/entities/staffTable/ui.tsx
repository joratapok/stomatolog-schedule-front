...
export const StaffTable: FC<Props> = React.memo(
  ({isAdmin, staff, title, sx}) => {
    ...
    const openRedactStaffModal = (person: IDoctor) => {
      dispatch(setCurrentStaff(person));
      dispatch(setModal(ESettingsModals.REDACTOR_STUFF));
    };
